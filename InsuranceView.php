...
<div class="container">
    <div class="row">
        <form role="form" action="InsuraceTest.php" method="post">
            <div class="col-lg-6">
                <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Insurance</strong>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="insu_id" id="InputName"
